 ...
 * @generated
 */
public class EDFDFlowTrackingPackageImpl extends EPackageImpl implements EDFDFlowTrackingPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see eDFDFlowTracking.EDFDFlowTrackingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private EDFDFlowTrackingPackageImpl() {
		super(eNS_URI, EDFDFlowTrackingFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link EDFDFlowTrackingPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static EDFDFlowTrackingPackage init() {
		if (isInited) return (EDFDFlowTrackingPackage)EPackage.Registry.INSTANCE.getEPackage(EDFDFlowTrackingPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredEDFDFlowTrackingPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		EDFDFlowTrackingPackageImpl theEDFDFlowTrackingPackage = registeredEDFDFlowTrackingPackage instanceof EDFDFlowTrackingPackageImpl ? (EDFDFlowTrackingPackageImpl)registeredEDFDFlowTrackingPackage : new EDFDFlowTrackingPackageImpl();
		...
		theEDFDFlowTrackingPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EDFDFlowTrackingPackage.eNS_URI, theEDFDFlowTrackingPackage);
		return theEDFDFlowTrackingPackage;
	}
	 ...
	 * @generated
	 */
	public EDFDFlowTrackingFactory getEDFDFlowTrackingFactory() {
		return (EDFDFlowTrackingFactory)getEFactoryInstance();
	}
